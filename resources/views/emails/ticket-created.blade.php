...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background: #0f172a; color: #e2e8f0; margin: 0; padding: 40px 20px;">
    <div style="max-width: 560px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #6366f1, #7c3aed, #a855f7); border-radius: 16px 16px 0 0; padding: 28px; text-align: center;">
            <h1 style="color: white; font-size: 22px; font-weight: 700; margin: 0;">Support Ticket Created</h1>
        </div>
        <div style="background: #1e293b; border-radius: 0 0 16px 16px; padding: 28px; border: 1px solid #334155;">
            <p style="font-size: 14px; color: #94a3b8; margin: 0 0 16px;">Your support ticket has been received. Our team will respond shortly.</p>
            ...
            <div style="background: #0f172a; border-radius: 12px; padding: 16px; margin-bottom: 16px; border: 1px solid #334155;">
                ...
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                    <span style="color: #64748b; font-size: 12px;">Category:</span>
                    <span style="color: #e2e8f0; font-size: 13px; text-transform: capitalize;">{{ $ticket->category }}</span>
                </div>
                <div style="display: flex; justify-content: space-between;">
                    <span style="color: #64748b; font-size: 12px;">Priority:</span>
                    <span style="color: #e2e8f0; font-size: 13px; text-transform: capitalize;">{{ $ticket->priority }}</span>
                </div>
            </div>
            
            <p style="font-size: 13px; color: #64748b; margin: 16px 0 0; text-align: center;">You can view your ticket and reply from your dashboard.</p>
        </div>
    </div>
</body>
</html>
